        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
            <div>
              ...
              <h2 className="text-4xl font-bold mb-6">Sizden Haber Almaktan Mutluluk Duyarız</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Ofis Adresimiz</h3>
                    <p className="text-gray-700">123 Coşkun Hafriyat Sk, Sanayi Sitesi, İstanbul, 34000</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-amber-100 p-3 rounded-full mr-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">info@guclukepce.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-amber-100 p-3 rounded-full mr-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Çalışma Saatlerimiz</h3>
            ...
            <div>
              <div id="quote-form" className="scroll-mt-24">
                ...
                <form className="bg-gray-50 dark:bg-gray-800 p-10 rounded-2xl shadow-sm">
                  <h3 className="text-2xl font-bold mb-6">Bize Bir Mesaj Gönderin</h3>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-gray-300 h-[400px] rounded-2xl overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-gray-600 text-lg font-medium">Etkileşimli Harita Buraya Gelecektir</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl font-bold mb-6">Sıkça Sorulan Sorular</h2>
            <p className="text-gray-700 text-lg">Hizmetlerimiz ve süreçlerimizle ilgili sıkça sorulan soruların yanıtlarını bulun.</p>
          </div>
